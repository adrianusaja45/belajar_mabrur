...
void main() async {
  try {
    ...
    runApp(MaterialApp(
        home: Scaffold(body: Center(child: Text("Gagal Startup:  $e")))));
  }
}
...
class _MyAppState extends State<MyApp> {
  ...
  void _handleMessage(RemoteMessage message) {
    if (message.data['lat'] != null) {
      String senderName =
          message.data['sender_name']?.toString() ?? "Seseorang";
    ...
    return MultiRepositoryProvider(
      ...
      child: MultiBlocProvider(
        ...
        child: MaterialApp(
          ...
          // ============================================
          // PENTING:  Tambahkan builder untuk Mini Overlay
          // dengan contextQuery yang diperlukan
          // ============================================
          builder: (context, child) {
            return Stack(
              children: [
                child!,
                // Mini overlay Zego untuk PIP
